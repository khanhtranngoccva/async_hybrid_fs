...
impl<'a, Target> UringPendingIo<Result<(), io::Error>> for UringFtruncate<'a, Target>
where
    Target: UringTarget + Sync + ?Sized,
{
...
where
    Target: UringTarget + Sync + ?Sized,
{
    pub(crate) fn new(client: &'a Client, target: &'a Target, len: u64) -> Self {
